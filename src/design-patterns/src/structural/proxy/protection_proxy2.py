...
class ResponsiblePerson:
  ...
  # Notice that in the class `Person`, `age` can be accessed directly,
  # in order to duplicate the behavior, we need to define a new
  # property and a new setter in the proxy class.

...
><details>
><summary> Better code example: Bank account with undo </summary>
>
>```python
>{{#include src/behavioral/command.py}}
>```
>
></details>
...
><details>
><summary> Code example: Transfer between bank accounts </summary>
>
>```python
>{{#include src/behavioral/composite_command.py}}
>```
>
></details>
